        ...
        if(!ap_rst_n | IM_done)begin
            ...
            if(pointer_tvalid)begin
                if(set_switch==0)begin
                    ...
                    else ACF_LUT_address[1] <= ACF_LUT_address[1]+1;
                end
            end
        end
        else begin
...
/////////////////////////////////////// OUTPUT AXI ////////////////////////////////////
    ...
    always_ff@(posedge ap_clk)begin
        ...
        if(!ap_rst_n | IM_done)begin
            ...
            FIFO_IN_tvalid <= 1;
            if(output_bit_count>=96) FIFO_IN_tlast <= 0;
            else begin
              FIFO_IN_tlast <= 1;
              output_done <= 1;
             end
...
/////////////////////////////// FINAL OUTPUT END ////////////////////////////////////
    ...
    always_ff@(posedge ap_clk)begin
        ...
        else if(FIFO_IN_tvalid && FIFO_IN_tlast) IM_done <= 1;
        else IM_done <= 0; 
    end
